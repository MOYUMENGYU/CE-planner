...
extern MemberList_pointer *gpos_c_in_clause_fixed;/* up to here, list corresp. to fixed CNF */
extern MemberList_pointer *gpos_c_in_clause_end;/* this is current list end */
