(define (domain adder)
   ...
   (:predicates (high ?b - bit) (low ?b - bit) (constant ?b - bit)
    (igc-ce-baf65d33e7-sel-0000)
    (igc-ce-baf65d33e7-sel-0001)
  )
   (:action and-gate
...
(define (problem p1)
  ...
  (:init
    (and
      ...
      (not (low tmp2))
      (not (low x1))
      (oneof (igc-ce-baf65d33e7-sel-0000) (igc-ce-baf65d33e7-sel-0001))
      (or (not (igc-ce-baf65d33e7-sel-0000)) (high y1))
      (or (not (igc-ce-baf65d33e7-sel-0000)) (not (low y1)))
      (or (not (igc-ce-baf65d33e7-sel-0001)) (not (high y1)))
      (or (not (igc-ce-baf65d33e7-sel-0001)) (low y1))
    )
  )
