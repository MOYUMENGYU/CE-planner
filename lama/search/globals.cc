...
/*配置参数*/
bool open_plan_optimize;
bool dynamic_reference_state;
bool static_reference_state;
bool open_frame_relax;
bool open_closed_loop_avoidance;
bool original_dynamic;
bool smt_simplifier;
SMTSolverBackend g_smt_solver_backend = SMT_SOLVER_Z3;
bool g_enable_cnf_preprocess = false;
