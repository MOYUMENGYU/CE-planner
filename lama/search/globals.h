...
enum SMTSolverBackend {
    SMT_SOLVER_Z3 = 0,
    SMT_SOLVER_CVC4 = 1,
    SMT_SOLVER_MATHSAT5 = 2,
    SMT_SOLVER_YICES2 = 3
};

const char *smt_solver_backend_name(SMTSolverBackend backend);

extern int fail_time;

extern bool open_plan_optimize;
extern bool dynamic_reference_state;
extern bool static_reference_state;
extern bool open_frame_relax;
extern bool open_closed_loop_avoidance;
extern bool original_dynamic;
extern bool smt_simplifier;
extern SMTSolverBackend g_smt_solver_backend;
extern bool g_enable_cnf_preprocess;
#endif
